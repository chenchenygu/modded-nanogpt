...
for _ in range(num_trials):
    ...
    schedule_steps = 3125
    lr_power = 1.5
    adam_lr_floor = 0.03933816945537044
    klsoap_lr_floor = 0.016930477847468664
    print0("KL-SOAP-H config: train_steps=3050 schedule_steps=3125 lr_power=1.5 "
           "adam_lr_floor=0.03933816945537044 klsoap_lr_floor=0.016930477847468664 "
